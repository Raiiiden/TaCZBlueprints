...
public class ModRegistry {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, com.raiiiden.taczblueprints.TaCZBlueprints.MODID);
    ...
    public static final RegistryObject<CreativeModeTab> TACZBLUEPRINTS_TAB = CREATIVE_MODE_TABS.register("taczblueprints_tab",
